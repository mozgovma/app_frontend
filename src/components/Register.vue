<template>
      ...
      <div class="auth-box">
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="input-group">
            ...
            <input type="password" v-model="confirmPassword" id="confirmPassword" placeholder="Confirm your password" required />
          </div>
  ...
  <script setup>
    ...
    const toggleForm = () => {
  emit('toggle-form', 'login'); // Сообщаем родителю, что нужно переключиться на форму логина
};
  </script>
